 ...
 */
class THMenuBar extends TElement
{
     ...
     */
    public static function newFromXML($xml_file, $permission_callback = NULL, $bar_class = 'iquedev-wrapper-info-header', $menu_class = 'dropdown-menu', $item_class = 'iquedev-user-header')
    {
        if (file_exists($xml_file))
        {
            ...
            foreach ($xml as $xmlElement)
            {
                ...
                $menu = new THMenu($xmlElement-> menu-> menuitem, $permission_callback, 1, $menu_class, $item_class);
